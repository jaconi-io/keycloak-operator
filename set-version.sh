...
replace_value_in_file ".*DefaultKeycloakImage.*= " "quay.io\/keycloak\/keycloak:$1-legacy" "internal/model/image_manager.go" "\""
replace_value_in_file ".*image: " "quay.io\/keycloak\/keycloak-operator:$1-legacy" "deploy/operator.yaml"
replace_value_in_file ".*DefaultKeycloakInitContainer.*= " "quay.io\/keycloak\/keycloak-init-container:$1-legacy" "internal/model/image_manager.go" "\""
